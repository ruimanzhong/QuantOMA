...
def main() -> None:
    ...
    if not series_path.exists():
        raise SystemExit("Run python scripts/data/fetch_gold_local_series.py first.")
    ...
    elif not feature_config.get("include_alpha158", False):
        print("Alpha158 features: disabled by config")
